...
ap.add_argument("-m", "--model", required=False,
	help="path to trained serialized model", default='model/activity.model')
ap.add_argument("-l", "--label-bin", required=False,
	help="path to  label binarizer", default='model/lb.pickle')
ap.add_argument("-i", "--input", required=False,
	help="path to our input video", default='example_clips/walk_196.mp4')
...
LABELS = ["Eat", "Sit", "Sleep", "Stand", "Walk"]
